...
module "aws_eks" {
  ...
  # DZ: below are IAM roles and Policies. If EKS blueprint was deployed before those were created already
  # so instead of trying to create again and fail, need to supply ARM of existing roles and policies
  # create_iam_role               = false
  # iam_role_arn                   = "arn:aws:iam::133776528597:role/eks-cluster-with-new-vpc-cluster-role"
  # DZ end iam_role_arn hack 
  ...
  # DZ tentative hack to avoid clashes with IRSA policies 
  #enable_irsa              = false
