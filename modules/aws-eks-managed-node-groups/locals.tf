locals {
  default_managed_ng = {
    ...
    # DZ: hack not to create node group role
    # create_iam_role = false
    # iam_role_arn will be used if create_iam_role=false
    # DZ: copied from existing node group policy
    # iam_role_arn    = "arn:aws:iam::133776528597:instance-profile/eks-b8c27c90-1e00-b041-5461-b1e4cc395933"
